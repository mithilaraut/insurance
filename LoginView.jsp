...
.login-wrap{
	...
	min-height:670px;
	position:relative;
	background:url(https://images.pexels.com/photos/248747/pexels-photo-248747.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500) no-repeat center;
...
<div class="login-wrap">
	<div class="login-html">
		...
		<sf:form method="post" action="LoginVerification" >
			...
			<sf:form method="post" action="registerPage" modalAttribute="user">
			...
			<div class="group">
				...
				<div class="group">
					...
					<input id="user" type="number" name="phone" class="input"  required=" ">
				</div>
				<div class="group">
					<label for="pass" class="label">Email Address</label>
					<input id="pass" type="Email" name="userName" class="input" required=" ">
				</div>
